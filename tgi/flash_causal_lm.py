...
from text_generation_server.utils.tokens import TokenHealingLogitsProcessor
...
class FlashCausalLMBatch(Batch):
    ...
    healed_offsets: List[Optional[int]]
    ...
    def from_pb(
        ...
        for i, (r, tokenized_input) in enumerate(
            ...
            healed_offsets.append(len(healed_token_ids))

            if len(healed_token_ids) > 0:
                tokenized_input = len(healed_token_ids) * [tokenizer.pad_token_id] + tokenized_input[: -len(healed_token_ids)]
            
            # batch decode this value
            input_text_length.append(len(tokenizer.decode(tokenized_input + healed_token_ids)))
            processors[i] = healer
    ...
    def filter(self, request_ids: List[int]) -> "FlashCausalLMBatch":
        ...
        for i, request_id in enumerate(request_ids):
            ...
            healed_offsets.append(self.healed_offsets[idx])
    ...
    def concatenate(cls, batches: List["FlashCausalLMBatch"]) -> "FlashCausalLMBatch":
        ...
        for i, batch in enumerate(batches):
            ...
            healed_offsets.extend(batch.healed_offsets)
...
class FlashCausalLM(Model):
    ...
    def generate_token(
        ...
        for i, (
            ...
            batch.healed_offsets[i] = healed_offset
